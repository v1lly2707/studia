...
def load_iris():
    data = pd.read_csv("C:/Users/fswin/OneDrive/Pulpit/studia/IV semestr/SI/laby/lab5SI/kmeans/data/iris.data", names=["sepal_length", "sepal_width", "petal_length", "petal_width", "class"])
    print(data)
